...
public class RepeatAndMissingNumberArray {
	...
	public static void main(String[] args) {
		Integer a[] = { 389, 299, 65, 518, 361, 103, 342, 406, 24, 79, 192, 181, 178, 205, 38, 298, 218, 143, 446, 324,
		...
		ArrayList<Integer> a1 = new RepeatAndMissingNumberArray().repeatedNumber(ar);
